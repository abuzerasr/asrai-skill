...
description: |
  ...
  Use when: crypto prices, market analysis, trading signals, sentiment, investment advice, technical indicators, Elliott Wave, smart money analysis, DEX data, or AI crypto forecasting.
